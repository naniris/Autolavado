        ...
        <div class="col-lg-5" style="margin-left: 30%">
            <div class="form-group">
                ...
                <s:select label="N° del Trabajador" headerKey="-1"
                          ...
                          list="Trabajador" listValue="nombre" listKey="idTrabajador" name="idTrabajador"/>
                <br>
                ...
                <br>
                    ...
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="basic-addon1">Nick del Administrador:</span>
                        ...
                        <s:textfield type="text" name="nickUsuario" maxlength="20" class="form-control" placeholder="Nick del Administrador" aria-label="Username" aria-describedby="basic-addon1" readonly="true"/>
                    </div>
                    <div class="input-group mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="basic-addon1">Nombre(s):</span>
                    </div>
                        <s:textfield type="text" name="nombre" maxlength="30" class="form-control" placeholder="Nombre(s)" aria-label="Username" aria-describedby="basic-addon1"/>
                    </div>
                    <div class="input-group mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="basic-addon1">Apellido Paterno:</span>
                    </div>
                        <s:textfield type="text" name="apellidoP" maxlength="20" class="form-control" placeholder="Apellido Paterno" aria-label="Username" aria-describedby="basic-addon1"/>
                    </div>
                    <div class="input-group mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="basic-addon1">Apellido Materno:</span>
                    </div>
                        <s:textfield type="text" name="apellidoM" maxlength="20" class="form-control" placeholder="Apellido Materno" aria-label="Username" aria-describedby="basic-addon1"/>
                    </div>
                    <div class="input-group mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="basic-addon1">Telefono:</span>
                    </div>
                        <s:textfield type="text" name="telefono" maxlength="13" class="form-control" placeholder="Telefono" aria-label="Username" aria-describedby="basic-addon1"/>
                    </div>
